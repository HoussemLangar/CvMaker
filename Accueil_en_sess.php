...
if (isset($_POST['creer'])) {
    header("Location: CvMakers_en.php?token=$session_token");}
if (isset($_POST['deconnexion'])) {
    session_unset();
    session_destroy();
    header("Location: Accueil_en.php");}
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <header class="navbar">
        <div class="container">
            <a href="CvMakers_en.php">Create your CV</a>
            <a href="#section2">Template</a>
            <a href="#util">How to create your CV</a>
        </div>
        <form action="" method="POST">
        <button class="con-button" name="deconnexion">Logout</button>
    </header>
    ...
    <section id="section" class="hero">
        <div class="container">
            ...
            <button class="cta-button" name="creer">Create a Resume</button>
        </div>
    </section>
    <section class="img" id="section2">
        <img src="template0.png" class="image"/>
        <button class="image-button" name="creer">Click here</button>
    </section>
    <section class="img" id="section2">
