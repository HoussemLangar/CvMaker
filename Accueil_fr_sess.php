...
if (isset($_POST['creer'])) {
    header("Location: CvMakers_fr.php?token=$session_token");}
...
<body>
    <header class="navbar">
        ...
        <form action="" method="POST" id="f">
            <button name="creer" class='a'>Créez votre CV</button>
            <button class='a'>Template</button>
            <button class='a'>Comment créez votre CV</button>
        </form>    
        </div>
    ...
    <section id="section" class="hero">
        <div class="container">
            ...
            <form action="" method="POST">
                <button class="cta-button" name="creer">Créer un CV</button>
        </div>
    </section>
    <section class="img" id="section2">
        <img src="template0.png" class="image"/>
        <button class="image-button" name="creer">Cliquez ici</button>
    </section>
    <section class="img" id="section2">
