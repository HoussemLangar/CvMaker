...
<body>
    <header class="navbar">
        <div class="container">
            <a href="Connexion_ar.php">أنشئ سيرتك الذاتية</a>
            <a href="#section2">القالب</a>
            <a href="#util">كيفية إنشاء سيرتك الذاتية</a>
        </div>
        <a href="Connexion_ar.php"><button class="con-button">تسجيل الدخول</button></a><a href="Signup_ar.php"><button class="con-button">اشترك الآن</button></a>
    </header>
    ...
    <section id="section" class="hero">
        <div class="container">
            ...
            <a href="Connexion_ar.php" class="cta-button">إنشاء سيرة ذاتية</a>
        </div>
    </section>
    <section class="img" id="section2">
        <img src="template0.png" class="image"/>
        <button class="image-button">انقر هنا</button>
    </section>
    <section class="img" id="section2">
